...
Sub MonitoringPerformance(lblTotalPhysMem As Label, lblAvaiMem As Label, _
                            lblSystemCache As Label)
...
'    DoEvents
    ...
    lblTotalPhysMem.Caption = Format(ps.PhysicalTotal * page \ 1024, "###,###") & " MB"
    lblAvaiMem.Caption = Format(ps.PhysicalAvailable * page \ 1024, "###,###") & " MB"
    lblSystemCache.Caption = Format(ps.SystemCache * page \ 1024, "###,###") & " MB"
